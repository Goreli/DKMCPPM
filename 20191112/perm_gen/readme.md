...
In the example below the logarithm base has been explicitly set to a 2 in order to express entropy in 2 based information measurement units (bits). Note that entropy of this random dataset composed of 8 distinct characters equals 3 bits.
