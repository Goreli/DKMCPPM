 ...
 * **-r gsize**  - randomly pick one permutation from each consecutive group generated by the default permutation generator. The gsize number specifies the size of the groups. This option invalidates options **-a**, **-l** and **-p**.
