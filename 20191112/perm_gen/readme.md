 ...
 * **str_perm_gen_b.cpp** - this is the main entry module of the str-perm-gen-b application. It implements a string type specialisation of the generic permutation engine along with a minimalistic command line interface. The purpose is to benchmark performance of the string permutation process. The command line interface is very simple and has been implemented inside this module;
